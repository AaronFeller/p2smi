...
def test_modify_sequence_modifications_included():
    ...
    mod_seq, mods = modify_sequence(test_seq, methylate=True, pegylate=True, nmeth_residues=0.5)
...
def test_process_sequences_runs_and_marks_modifications():
    ...
    results = list(process_sequences(input_lines, nmeth_rate=1.0, peg_rate=1.0, nmeth_residues=0.5))
